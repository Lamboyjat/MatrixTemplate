...
#ifndef MATRIXTEMPLATE_ITERATOR_H
#define MATRIXTEMPLATE_ITERATOR_H
...
public:
    MatrixRowMajorIterator(MD data, unsigned row, unsigned col) : BaseMatrixIterator<T, MD>(data, row, col) {}
...
#endif //MATRIXTEMPLATE_ITERATOR_H
